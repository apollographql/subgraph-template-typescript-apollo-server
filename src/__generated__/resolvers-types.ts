...
> = ResolversObject<{
  __resolveReference?: ReferenceResolver<
    Maybe<ResolversTypes['Foo']>,
    { __typename: 'Foo' } & GraphQLRecursivePick<ParentType, { id: true }>,
    ContextType
  >;
...
> = ResolversObject<{
  bar?: Resolver<
    Maybe<ResolversTypes['Bar']>,
    ParentType,
    ContextType,
    RequireFields<QueryBarArgs, 'id'>
  >;
  foos?: Resolver<
    Maybe<Array<Maybe<ResolversTypes['Foo']>>>,
    ParentType,
    ContextType
  >;
